...
const char WIFI_SSID[] PROGMEM = "Galaxyy A32 MGR";
const char WIFI_PASS[] PROGMEM = "hola1234";
...
void loop() {
  ...
  if (currentMillis - prevSensorMillis >= SENSOR_INTERVAL) {
    ...
    Serial.println(adc_mq131);

    // Mostrar gases calculados
    Serial.print(F("NH3:"));
    Serial.print(ppm_nh3, 1);
    Serial.print(F(" NOx:"));
    Serial.print(ppm_nox, 1);
    Serial.print(F(" CO2:"));
    Serial.print(ppm_co2, 1);
