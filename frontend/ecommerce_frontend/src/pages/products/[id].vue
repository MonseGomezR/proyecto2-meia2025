    ...
    <div v-if="product" class="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow">
        ...
        <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="flex-1 flex flex-col gap-4">
                ...
                <p class="font-semibold text-lg">Precio: ${{ product.price.toFixed(2) }}</p>
                ...
                <div class="flex items-center gap-3 mt-2">
                    <button @click="decreaseCount" class="px-3 py-1 bg-gray-200 rounded hover:bg-gray-300">-</button>
                    <span class="font-semibold">{{ count }}</span>
                    <button @click="increaseCount" class="px-3 py-1 bg-gray-200 rounded hover:bg-gray-300">+</button>
                </div>
...
const addToCart = (product) => {
    ...
    cartStore.addManyToCart(product, quantity.value)
    count.value = 0;
}
</script>
